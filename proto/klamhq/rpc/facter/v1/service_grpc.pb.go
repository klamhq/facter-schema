...
func (c *factGrpcServiceClient) Inventory(ctx context.Context, in *InventoryRequest, opts ...grpc.CallOption) (*InventoryResponse, error) {
	...
	err := c.cc.Invoke(ctx, FactGrpcService_Inventory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedFactGrpcServiceServer must be embedded to have
...
func (UnimplementedFactGrpcServiceServer) Inventory(context.Context, *InventoryRequest) (*InventoryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Inventory not implemented")
}
func (UnimplementedFactGrpcServiceServer) CheckRules(context.Context, *CheckRulesRequest) (*CheckRulesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CheckRules not implemented")
}
...
func RegisterFactGrpcServiceServer(s grpc.ServiceRegistrar, srv FactGrpcServiceServer) {
	// If the following call panics, it indicates UnimplementedFactGrpcServiceServer was
...
func _FactGrpcService_Inventory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FactGrpcService_Inventory_FullMethodName,
	}
